...
function call_start_recording(){
  ...
  if($("#mic_record").attr("src") == "images/Player_Record.png"){
	  $("#mic_record").attr("src", "images/Player_Stop.png");
  }else{
	  $("#mic_record").attr("src", "images/Player_Record.png");
  }
}

function call_save_recording(){
  thisMovie("jfrec").save_recording();
}
